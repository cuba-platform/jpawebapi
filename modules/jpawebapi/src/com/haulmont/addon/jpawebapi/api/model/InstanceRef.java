...
public class InstanceRef {
    ...
    protected EntityLoadInfo loadInfo;
    protected BaseGenericIdEntity<Object> instance;

    public InstanceRef(EntityLoadInfo loadInfo) {
        if (loadInfo == null)
    ...
    public boolean equals(Object o) {
        ...
        if (!loadInfo.getId().equals(that.loadInfo.getId())) {
            return false;
        }

        return loadInfo.getMetaClass().equals(that.loadInfo.getMetaClass());
    }
