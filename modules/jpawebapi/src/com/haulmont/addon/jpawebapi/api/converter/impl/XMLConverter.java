...
import com.haulmont.addon.jpawebapi.api.model.InstanceRef;
...
public class XMLConverter implements Converter {
    ...
    static {
        try {
            ...
            throw new RuntimeException("Failed to create MIME type: 'text/xml;charset=UTF-8'", e);
        }
    }
    ...
    public CommitRequest parseCommitRequest(String content) {
        try {
            ...
            throw new RuntimeException("An error occurred while parsing commit request", e);
        }
    }
    ...
    public QueryRequest parseQueryRequest(String content) throws IllegalArgumentException, ClassNotFoundException, ParseException {
        ...
        if (rootElement.element("dynamicAttributes") != null) {
            ...
            boolean dynamicAttributes = Boolean.parseBoolean(dynamicAttributesString);
    ...
    public Collection<? extends Entity> parseEntitiesCollection(String content, Class<? extends Collection> collectionClass) {
        try {
            ...
            throw new RuntimeException("An error occurred while parsing entities collection", e);
        }
    }
    ...
    protected Entity parseEntity(Element instanceEl, @Nullable Entity entity, @Nullable CommitRequest commitRequest) {
        try {
            ...
            for (Object el : propertyEls) {
                ...
                switch (property.getType()) {
                    ...
                    case ASSOCIATION:
                        ...
                        if (commitRequest != null && !updatePermitted(propertyMetaClass) && readNotPermitted(propertyMetaClass))
                            break;
            ...
            throw new RuntimeException("An error occurred while parsing an entity", e);
        }
    }
    ...
    protected void encodeEntity(Entity entity, HashSet<Entity> visited, View view, Element parentEl) throws Exception {
        ...
        if (readNotPermitted(entity.getMetaClass()))
    ...
    protected String documentToString(Document document) {
        try {
            ...
            throw new RuntimeException("An error occurred while converting XML Document to String", e);
        }
    }
}
