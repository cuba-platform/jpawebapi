...
public interface Converter {
    ...
    /**
     * Converts an entity to string representation of search result in a format of current {@code converter}
     * (xml, json, etc).
     */
    String process(Entity entity, MetaClass metaclass, View view) throws Exception;

    /**
     * Converts an collection of entities to string representation of search result in a format of current
     * {@code converter} (xml, json, etc).
     */
    String process(List<Entity> entities, MetaClass metaClass, View view) throws Exception;

    /**
     * Converts an collection of entities to string representation of commit result in a format of current
     * {@code converter} (xml, json, etc).
     */
     ...
     *
     * @param content string representation of entities collection
