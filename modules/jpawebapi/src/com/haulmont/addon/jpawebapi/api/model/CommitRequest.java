...
public class CommitRequest {
    ...
    protected Collection commitInstances;
    protected Collection removeInstances;
    protected boolean softDeletion = true;
    protected Set<String> newInstanceIds = new HashSet<>();
    protected Map<String, InstanceRef> instanceRefs = new HashMap<>();
    protected Set<String> commitIds = new HashSet<>();
    ...
    public InstanceRef parseInstanceRefAndRegister(String fullId) {
